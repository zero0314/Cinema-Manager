		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"0px","margin":"0 0 0 20px","background":"none","display":"flex","width":"100px","justifyContent":"space-between","order":"5"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0","borderColor":"#fde2db #fbccc0 #f58c71","margin":"0","textAlign":"center","display":"flex","justifyContent":"center","top":"180px","flexWrap":"wrap","left":"20px","background":"none","borderWidth":"0px","width":"calc(100% - 20px)","position":"absolute","borderStyle":"solid"}' >
					<div :style='{"width":"auto","margin":"0 10px 0 0","background":"none","display":"inline-block"}'>
						<label :style='{"padding":"0 4px 0 0","color":"#666","textAlign":"right","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">影院场次</label>
						<el-input v-model="searchForm.yingyuanchangci" placeholder="影院场次" clearable></el-input>
					</div>
			...
			<!-- <div> -->
				<el-table class="tables"
					...
					v-if="isAuth('yingyuanchangci','查看')"
					:data="dataList"
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.yingyuanchangci!='' && this.searchForm.yingyuanchangci!=undefined){
            params['yingyuanchangci'] = '%' + this.searchForm.yingyuanchangci + '%'
          }
      this.$http({
        url: "yingyuanchangci/page",
        method: "get",
        params: params
      }).then(({ data }) => {
        if (data && data.code === 0) {
